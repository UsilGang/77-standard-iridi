...
| Standard as Code architecture | [[01_Projects/001_77_Standard_iRidi/Artifacts/Documentation/Standard_As_Code_Architecture_v1]] | proposal | модель артефактов, UID, versioning, build, MCP и migration plan |
...
| Content refactoring and templates | [[01_Projects/001_77_Standard_iRidi/Artifacts/Documentation/Standard_Content_Refactoring_And_Template_Model_v1]] | proposal | lossless import, normalized canon, archetypes и защита от побочных правил |
| Editorial assignment and versioning | [[01_Projects/001_77_Standard_iRidi/Artifacts/Documentation/Editorial_Assignment_And_Versioning_Model_v1]] | proposal | EDT contract, text/visual brief, unit revisions, draft builds и release SemVer |
| Audiences and agent knowledge access | [[01_Projects/001_77_Standard_iRidi/Artifacts/Documentation/Audience_And_Agent_Knowledge_Access_Model_v1]] | proposal | человеческие аудитории, machine applications, физическое разделение слоев, generated agent package и query/audit contract |
...
| [[01_Projects/001_77_Standard_iRidi/Reviews/2026-08-05_Standard_As_Code_Architecture_Review]] | перевод книги в версионируемый source layer, детерминированную сборку и released knowledge package | требует решения по D1-D7,D9-D11; D8 уже обязательный owner gate |
...
До approve агент может создавать только локальные proposals, source traces, QA reports и индексы. Google Doc, Wiki, внешние системы и публичные материалы не меняются автоматически.
